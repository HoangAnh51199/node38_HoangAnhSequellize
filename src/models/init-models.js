...
export default function initModels(sequelize) {
  ...
  orderfood.belongsTo(food, { as: "food", foreignKey: "food_id"});
  food.hasMany(orderfood, { as: "orderfoods", foreignKey: "food_id"});
  ...
  orderfood.belongsTo(users, { as: "user", foreignKey: "user_id"});
  users.hasMany(orderfood, { as: "orderfoods", foreignKey: "user_id"});
